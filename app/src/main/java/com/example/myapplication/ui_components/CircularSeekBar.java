...
public class CircularSeekBar extends View {
    ...
    private HashMap<String, Object> mPointerAttrs;
    ...
    private void initAttributes(TypedArray attrArray) {
        ...
        mPointerAttrs = new HashMap<>();
        setDisablePointer(mDisablePointer);
...
//            }
    ...
    */
    ...
    public void setDisablePointer(boolean disablePointer) {
        if (disablePointer == mDisablePointer)
            return;

        mDisablePointer = disablePointer;
        if (mDisablePointer) {
            mPointerAttrs.put("strokeWidth", mPointerStrokeWidth);
            mPointerAttrs.put("haloWidth", mPointerHaloBorderWidth);
            mPointerAttrs.put("haloBorderWidth", mPointerHaloBorderWidth);
            ...
            Object strokeWidth = mPointerAttrs.get("strokeWidth");
            if (strokeWidth != null) mPointerStrokeWidth = (float)strokeWidth;

            Object haloWidth = mPointerAttrs.get("haloWidth");
            if (haloWidth != null) mPointerHaloWidth = (float)haloWidth;

            Object haloBorderWidth = mPointerAttrs.get("haloBorderWidth");
            if (haloBorderWidth != null) mPointerHaloBorderWidth = (float)haloBorderWidth;
        }
        recalculateAll();
        invalidate();
    }
